...
<html lang="en">
  <head>
    ...
    <title>Produk Sepeda & Aksesorisnya</title>
    <link rel="stylesheet" href="sepeda.css" />
    <link
      rel="stylesheet"
  ...
  <body>
    ...
    <section class="category-nav">
      <div class="cat-container">
        ...
        <a href="mainan.html" class="cat-btn" data-category="mainan">Mainan</a>
        <a href="atk.html" class="cat-btn" data-category="alat">
          Alat Tulis & Kantor
        </a>
        <a href="#" class="cat-btn active" data-category="sepeda">
          Sepeda & Aksesorisnya
        </a>
      </div>
    </section>
